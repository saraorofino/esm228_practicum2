...
```{r measure2-population, message=FALSE, warning=FALSE}
...
population <- declare_population(
  ...
  owner = add_level(N=c(18000,34000,10500, 337, 5000, 2100, 4000, 89), # 35% of each county's homeowner population
...
# we are sampling by county, our strata. We're going to send out 1000 questionnaires in total: 500 questionnaires in Placer, 200 in El Dorado, 100 in Nevada, 70 in Yuba, 70 in Amador, 30 in Plumas, 15 in Sierra, and 15 in Alpine.
```
