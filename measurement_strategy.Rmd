...
Using demogrpahic data of each county, we found the approximate number of private land owners per county in the CABY region. We further assumedd 35% of homeowners owned land large enough to implement fuel management practices.  
